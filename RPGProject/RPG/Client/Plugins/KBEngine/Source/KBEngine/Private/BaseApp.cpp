...
DECLARE_CYCLE_STAT(TEXT("HandleMessage_MemoryStream"), STAT_HandleMessage_MemoryStream, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("HandleMessage_ArrayVariant"), STAT_HandleMessage_ArrayVariant, STATGROUP_KBEngine_BaseApp);

DECLARE_CYCLE_STAT(TEXT("Client_onHelloCB"), STAT_Client_onHelloCB, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onVersionNotMatch"), STAT_Client_onVersionNotMatch, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onScriptVersionNotMatch"), STAT_Client_onScriptVersionNotMatch, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onImportClientMessages"), STAT_Client_onImportClientMessages, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onImportClientEntityDef"), STAT_Client_onImportClientEntityDef, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onLoginBaseappFailed"), STAT_Client_onLoginBaseappFailed, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onReloginBaseappFailed"), STAT_Client_onReloginBaseappFailed, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onReloginBaseappSuccessfully"), STAT_Client_onReloginBaseappSuccessfully, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onReqAccountBindEmailCB"), STAT_Client_onReqAccountBindEmailCB, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onReqAccountNewPasswordCB"), STAT_Client_onReqAccountNewPasswordCB, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onAppActiveTickCB"), STAT_Client_onAppActiveTickCB, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onKicked"), STAT_Client_onKicked, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onControlEntity"), STAT_Client_onControlEntity, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onCreatedProxies"), STAT_Client_onCreatedProxies, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onEntityDestroyed"), STAT_Client_onEntityDestroyed, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdatePropertysOptimized"), STAT_Client_onUpdatePropertysOptimized, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdatePropertys"), STAT_Client_onUpdatePropertys, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("OnUpdatePropertys"), STAT_OnUpdatePropertys, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onRemoteMethodCallOptimized"), STAT_Client_onRemoteMethodCallOptimized, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onRemoteMethodCall"), STAT_Client_onRemoteMethodCall, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("OnRemoteMethodCall"), STAT_OnRemoteMethodCall, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onEntityEnterWorld"), STAT_Client_onEntityEnterWorld, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onEntityLeaveWorldOptimized"), STAT_Client_onEntityLeaveWorldOptimized, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onEntityLeaveWorld"), STAT_Client_onEntityLeaveWorld, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onEntityEnterSpace"), STAT_Client_onEntityEnterSpace, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onEntityLeaveSpace"), STAT_Client_onEntityLeaveSpace, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("AddSpaceGeometryMapping"), STAT_AddSpaceGeometryMapping, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_initSpaceData"), STAT_Client_initSpaceData, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_setSpaceData"), STAT_Client_setSpaceData, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_delSpaceData"), STAT_Client_delSpaceData, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateBasePos"), STAT_Client_onUpdateBasePos, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateBasePosXZ"), STAT_Client_onUpdateBasePosXZ, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateBaseDir"), STAT_Client_onUpdateBaseDir, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onSetEntityPosAndDir"), STAT_Client_onSetEntityPosAndDir, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData"), STAT_Client_onUpdateData, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_ypr"), STAT_Client_onUpdateData_ypr, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_yp"), STAT_Client_onUpdateData_yp, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_yr"), STAT_Client_onUpdateData_yr, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_pr"), STAT_Client_onUpdateData_pr, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_y"), STAT_Client_onUpdateData_y, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_p"), STAT_Client_onUpdateData_p, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_r"), STAT_Client_onUpdateData_r, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xz"), STAT_Client_onUpdateData_xz, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xz_ypr"), STAT_Client_onUpdateData_xz_ypr, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xz_yp"), STAT_Client_onUpdateData_xz_yp, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xz_yr"), STAT_Client_onUpdateData_xz_yr, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xz_pr"), STAT_Client_onUpdateData_xz_pr, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xz_y"), STAT_Client_onUpdateData_xz_y, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xz_p"), STAT_Client_onUpdateData_xz_p, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xz_r"), STAT_Client_onUpdateData_xz_r, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xyz"), STAT_Client_onUpdateData_xyz, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xyz_ypr"), STAT_Client_onUpdateData_xyz_ypr, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xyz_yp"), STAT_Client_onUpdateData_xyz_yp, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xyz_yr"), STAT_Client_onUpdateData_xyz_yr, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xyz_pr"), STAT_Client_onUpdateData_xyz_pr, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xyz_y"), STAT_Client_onUpdateData_xyz_y, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xyz_p"), STAT_Client_onUpdateData_xyz_p, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onUpdateData_xyz_r"), STAT_Client_onUpdateData_xyz_r, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("UpdateVolatileData"), STAT_UpdateVolatileData, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onStreamDataStarted"), STAT_Client_onStreamDataStarted, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onStreamDataRecv"), STAT_Client_onStreamDataRecv, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onStreamDataCompleted"), STAT_Client_onStreamDataCompleted, STATGROUP_KBEngine_BaseApp);
DECLARE_CYCLE_STAT(TEXT("Client_onParentChanged"), STAT_Client_onParentChanged, STATGROUP_KBEngine_BaseApp);
...
namespace KBEngine
{
	...
	void BaseApp::UpdatePlayerToServer()
	{
		...
		if (!playerEntity->IsControlled())
		{
			...
			else 
			{
				...
				bool TempneedUpdate = this->PlayerNeedUpdate(playerEntity, posHasChanged || dirHasChanged);
				if (TempneedUpdate)
				{
					playerEntity->lastSyncPos_ = position;
					playerEntity->lastSyncDir_ = direction;
		...
		for (auto* entity : controlledEntities_)
		{
			...
			else
			{
				...
				bool TempneedUpdate = this->PlayerNeedUpdate(entity, posHasChanged || dirHasChanged);
				if (TempneedUpdate)
				{
					entity->lastSyncPos_ = position;
					entity->lastSyncDir_ = direction;
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onHelloCB);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onVersionNotMatch);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onScriptVersionNotMatch);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onImportClientMessages);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onImportClientEntityDef);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onLoginBaseappFailed);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onReloginBaseappFailed);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onReloginBaseappSuccessfully);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onReqAccountBindEmailCB);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onReqAccountNewPasswordCB);
		if (failcode != (int)ERROR_TYPE::SUCCESS)
		{
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onControlEntity);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onKicked);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onCreatedProxies);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdatePropertysOptimized);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdatePropertys);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_OnUpdatePropertys);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onRemoteMethodCallOptimized);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onRemoteMethodCall);
		int32 eid = stream.ReadInt32();
		OnRemoteMethodCall(eid, stream);
	}
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_OnRemoteMethodCall);
		Entity* entity = FindEntity(eid);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onEntityEnterWorld);
		int32 eid = stream.ReadInt32();
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onEntityLeaveWorldOptimized);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onEntityLeaveWorld);
		Entity* entity = FindEntity(eid);
		if (!entity)
		{
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onEntityEnterSpace);
		int32 eid = stream.ReadInt32();
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onEntityLeaveSpace);
		Entity* entity = FindEntity(eid);
		if (!entity)
		{
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_AddSpaceGeometryMapping);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_initSpaceData);
		ClearSpace(false);
		spaceID_ = stream.ReadUint32();
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_setSpaceData);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_delSpaceData);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onEntityDestroyed);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateBasePos);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateBasePosXZ);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateBaseDir);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onSetEntityPosAndDir);
		int32 eid = stream.ReadInt32();
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_ypr);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_yp);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_yr);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_pr);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_y);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_p);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_r);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xz);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xz_ypr);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xz_yp);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xz_yr);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xz_pr);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xz_y);
		int32 eid = GetAoiEntityIDFromStream(stream);
		FVector2D xz = stream.ReadPackXZ();
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xz_p);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xz_r);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xyz);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xyz_ypr);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xyz_yp);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xyz_yr);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xyz_pr);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xyz_y);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xyz_p);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onUpdateData_xyz_r);
		int32 eid = GetAoiEntityIDFromStream(stream);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_UpdateVolatileData);
		//KBE_ERROR(TEXT("----------------------UpdateVolatileData----- entity(%d):%f,%f,%f"), entityID,x,y,z);
		...
		if (FMath::Abs(roll - KBEDATATYPE_BASE::KBE_FLT_MAX) > 0.0f)
		{
			changeDirection = true;
			direction.X = KBEMath::int82angle((int8)roll, false);
		}

		if (FMath::Abs(pitch - KBEDATATYPE_BASE::KBE_FLT_MAX) > 0.0f)
		{
			changeDirection = true;
			direction.Y = KBEMath::int82angle((int8)pitch, false);
		}

		if (FMath::Abs(yaw - KBEDATATYPE_BASE::KBE_FLT_MAX) > 0.0f)
		{
			changeDirection = true;
		...
		bool positionChanged = (FMath::Abs(x - FLT_MAX) > 0.0f) || (FMath::Abs(y - FLT_MAX) > 0.0f) || (FMath::Abs(z - FLT_MAX) > 0.0f);
		if (FMath::Abs(x - FLT_MAX) == 0.0f) x = 0.0;
		if (FMath::Abs(y - FLT_MAX) == 0.0f) y = 0.0;
		if (FMath::Abs(z - FLT_MAX) == 0.0f) z = 0.0;
		...
		//KBE_ERROR(TEXT("-----------------------BaseApp::UpdateVolatileData entity(%d):%f,%f,%f"), entityID, pos.X, pos.Y, pos.Z);
		if (done)
		{
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onStreamDataRecv);
		if (KBEPersonality::Instance())
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onStreamDataCompleted);
		if (KBEPersonality::Instance())
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_Client_onParentChanged);
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_HandleMessage_MemoryStream);
		if (name == "Client_onUpdatePropertysOptimized") {
	...
	{
		SCOPE_CYCLE_COUNTER(STAT_HandleMessage_ArrayVariant);
		if (name == "Client_onUpdateBasePosXZ") {

		Client_onUpdateBasePosXZ(args[0].GetValue<float>(), args[1].GetValue<float>());
		}
		else if (name == "Client_onCreatedProxies") {
